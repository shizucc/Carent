                ...
                <div class="col-md-4 gradient-custom text-center text-black",
                  ...
                  <i class="far fa-edit mb-5"></i>
                    ...
                    <div class="col-md-8">
                     ...
                     <a href="edit_data_diri.php?id=<?php echo $_SESSION['username'] ?>"><button type="button" class="btn btn-outline-secondary" style="width:100%;"> Edit Data</button></a>
