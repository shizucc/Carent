            ...
            <div class="card mb-3" style="border-radius: .5rem;">           
              <div class="row g-0" id="editData">
                <div class="col-md-4 gradient-custom text-center text-black",
                  ...
                  <br><br>
                  <form action="edit_data_diri.php" method="post">
                  ...
                  if(isset($_POST['update'])){
                    ...
                    if($query){
                      ...
                      <script>
                        ...
                        document.location = "data_diri.php"
                      </script>
                      <?php
                    }
                  ...
                  ?>
                      ...
                      <p><?php echo $_SESSION['role'] ?></p>
                        <button class="ganti">Ganti Foto</button>
                    </div>
                    <div class="col-md-8">
                      <div class="card-body p-4">
                        ...
                        <div class="row pt-1">
                          ...
                          <div class="col-6 mb-3">
                            <input type="int" name="no_hp" placeholder="Nomor HP" value=<?php echo $_SESSION['no_hp'] ?>>
                          </div>
                        </div>
                        <hr class="mt-0 mb-4">
                        
                        <div>
                          <input type="password" name="re_password" placeholder="Konfirmasi Password" style="width: 100%;">
                        </div>
                        <div class="row pt-1">
                          <div class="col-6 mb-3 ">
                            <a href="data_diri.php">
                              <input type="button" class="batal" onclick="location.href='data_diri.php';" value="Batal">
                            </a>
