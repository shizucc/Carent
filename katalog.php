...
<body>
  ...
  <!-- Filter : Jenis, Transmisi, Kapasitas -->
            ...
            <div class="container px-4 px-lg-5 mt-5">
              ...
              <div align="center">
                <form action="katalog.php" method="GET" name="formFilter">
                    <div class="filter">
                      <h3>Jenis</h3>
              ...
              <div class='row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center'>
                          ...
                          <div class="modal-footer">
                            ...
                            <a href="<?php 
                              ...
                              <?php
                                ...
                                ?>
                                tambah_pesanan.php?id=<?php echo $row['no_plat'] ?>
                                <?php
                              }
                             ?>
                            ">
                            <button type="button" class="btn btn-primary" >Rental Sekarang</button>
                          </a>
                          </div>
                        </div>
                      </div>
                ...
                <div class="modal fade" id="syaratBackdrop<?php echo $row['no_plat']?>" data-bs-backdrop="syarat" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="syaratBackdropLabel">Konfirmasi Perentalan</h1>
                    ...
                    <div class='h-100'>
                            ...
                            if(isset($_POST['insertPesanan'])){
                              ...
                              $tgl_pesam = date("d/m/Y");
                              $tgl_ambil = $_POST['tgl_ambil'];
                              $tgl_kembali = $_POST['tgl_kembali'];
                              $status = 'Menunggu Pembayaran';

                              $sql = "INSERT INTO `pesanan_user`(`username`, `no_plat`, `jumlah_hari`,`tanggal_pesan`,`tanggal_ambil`,`tanggal_kembali`,`status` VALUES(
                                '$username',
                                '$no_plat',
                                '$jumlah_hari',
                                '$tanggal_pesan',
                      ...
                      <form action="katalog.php" method="post">
                          ...
                          <div class="row">
                            <div class="col">
                              <select name="jml_hari" id="jml_hari">
                          ...
                          <h6>Tanggal Ambil</h6>
                          <input type="date" id="tgl_ambil"><br><br>
                          <h6>Tanggal kembali</h6>
                          <input type="date" id="tgl_kembali"><br><br>
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $row['no_plat'] ?>">Kembali</button>
